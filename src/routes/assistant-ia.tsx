  ...
  const [messages, setMessages] = useState<Msg[]>([
    {
      role: "assistant",
      content:
        "Bonjour. Je suis l'Assistant IA EcoKin Smart. Posez-moi vos questions sur l'état de la propreté, les risques et les priorités d'intervention.",
    },
  ]);
      ...
      <header className="border-b border-border bg-kin text-white">
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <p className="mt-1 text-white/70">
            L'IA croise les données EcoKin en temps réel : IPK, alertes, hotspots, météo,
            signalements.
          </p>
        </div>
      </header>
