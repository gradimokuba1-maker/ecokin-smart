  ...
  return (
    <div className="fixed inset-0 z-50 grid place-items-center bg-black/80 p-4 backdrop-blur-sm">
      <div className="relative w-full max-w-2xl rounded-2xl bg-card p-4">
        <CardTitle>
          Photo {type === "before" ? "Avant" : "Après"} - {report.id}
        </CardTitle>
      ...
      <main className="flex-1">
          ...
          <div className="container py-8">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2 rounded-xl border bg-background p-2 text-xs">
                ...
                {geoStatus === "ok" && (
                  <>
                    <Crosshair className="size-3 text-eco" />
                    <span>GPS Actif</span>
                  </>
                )}
                {geoStatus === "error" && (
                      ...
                      <Card key={report.id}>
                        <CardHeader>
                          ...
                          <p className="text-sm text-muted-foreground capitalize">
                            {report.category} · {report.commune}
                          </p>
                        </CardHeader>
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      <MapPinned className="size-4" /> Carte des missions
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ClientOnly
        ...
        {capturing && (
          <PhotoCapture
            ...
            onCapture={(dataUrl) =>
              handlePhotoCapture(capturing.report.id, capturing.type, dataUrl)
            }
          />
        )}
      </main>
