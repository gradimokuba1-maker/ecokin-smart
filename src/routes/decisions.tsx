      ...
      <header className="border-b border-border bg-secondary/40">
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <p className="mt-1 max-w-2xl text-muted-foreground">
            Chaque décision suivie publiquement : responsable, budget, avancement et résultats
            mesurés.
          </p>
        </div>
      </header>
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  ...
                  <div className="mt-1 text-xs text-muted-foreground">
                    Responsable : <b>{d.responsable}</b> · Lancée le {d.dateLancement} · Commune :{" "}
                    <span className="capitalize">{d.commune}</span>
                  </div>
                </div>
                <div className="text-right">
                  ...
                  <div className="font-display text-lg font-bold">
                    {(d.budget / 1_000_000).toFixed(1)} M CDF
                  </div>
                </div>
              </div>
