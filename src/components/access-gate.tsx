      ...
      <div className="mx-auto grid min-h-screen max-w-md place-items-center px-4">
        <div className="w-full rounded-3xl border border-border bg-card p-7 shadow-xl shadow-black/5">
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            Cet espace est réservé aux autorités habilitées. Sélectionnez votre rôle et saisissez votre
            code d'accès institutionnel.
          </p>
          ...
          >
            ...
            <div>
              <label className="text-xs font-bold uppercase tracking-widest text-muted-foreground">Code d'accès</label>
              <input
                value={code}
            ...
            <details className="rounded-xl bg-muted/50 p-3 text-xs text-muted-foreground">
              <summary className="cursor-pointer font-semibold">Codes de démonstration</summary>
