      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-3 rounded-lg border p-3">
            ...
            <Button onClick={submitPme} className="w-full">
              Ajouter la PME
            </Button>
          </div>
          ...
          <div className="space-y-3 rounded-lg border p-3">
            ...
            <Input
              ...
              value={collectorIdentifier}
              onChange={(e) => setCollectorIdentifier(e.target.value)}
            />
            <Input
              placeholder="Zone d'intervention"
              value={collectorZone}
              onChange={(e) => setCollectorZone(e.target.value)}
            />
            <Button onClick={submitCollector} className="w-full">
          ...
          <div className="space-y-3 rounded-lg border p-3">
            ...
            <Select value={selectedCollector} onValueChange={setSelectedCollector}>
              <SelectTrigger>
                <SelectValue placeholder="Collecteur" />
              </SelectTrigger>
              <SelectContent>
            ...
            <Button onClick={submitMission} className="w-full">
              Créer la mission
            </Button>
          </div>
        </CardContent>
