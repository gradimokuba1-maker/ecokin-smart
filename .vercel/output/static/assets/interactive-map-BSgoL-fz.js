...
import{a as e}from"./rolldown-runtime-CNC7AqOf.js";import{n as t,t as n}from"./jsx-runtime-BtyjnKZj.js";import{n as r}from"./createLucideIcon-B9xELM86.js";import{u as i}from"./site-nav-BCScwA0S.js";import{L as a,R as o,ct as s,lt as c}from"./index-CkfOfduL.js";var l=e(t(),1),u=n();c();var d={transfert:{label:`Centre de transfert`,color:`#0ea5e9`,glyph:`T`},regroupement:{label:`Point de regroupement`,color:`#f59e0b`,glyph:`R`},valorisation:{label:`Centre de valorisation`,color:`#10b981`,glyph:`V`},traitement:{label:`Centre de traitement`,color:`#6366f1`,glyph:`X`},collecte:{label:`Zone de collecte`,color:`#14b8a6`,glyph:`C`},tri:{label:`Centre de tri`,color:`#22c55e`,glyph:`Tri`},recyclage:{label:`Recyclage`,color:`#84cc16`,glyph:`♻`}};function f({commune:t,reports:n=[],heightClassName:c=`h-[420px]`}){let f=(0,l.useRef)(null),p=(0,l.useRef)(null);return(0,l.useEffect)(()=>{let c=!1;return(async()=>{let l=(await s(async()=>{let{default:t}=await import(`./leaflet-src-DtpoAO3a.js`).then(t=>e(t.t(),1));return{default:t}},__vite__mapDeps([0,1]))).default;if(await s(()=>import(`./leaflet-DM_40lI3.js`).then(e=>e.t),__vite__mapDeps([2,1,3])),c||!f.current)return;let u=t?o.find(e=>e.id===t):null,m=l.map(f.current,{zoomControl:!0,scrollWheelZoom:!0}).setView(u?.center??r.center,u?14:r.defaultZoom);l.tileLayer(`https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png`,{attribution:`© OpenStreetMap · © CARTO · EcoKin Smart`,maxZoom:19}).addTo(m),(u?[u]:o).forEach(e=>{l.circle(e.center,{radius:u?1900:1200,color:e.color,weight:1.6,opacity:.55,fillOpacity:.06,dashArray:`5 5`}).bindTooltip(`Commune de ${e.name}`,{direction:`top`}).addTo(m)}),a.filter(e=>!t||e.commune===t).forEach(e=>{let t=d[e.kind]??d.collecte;l.marker([e.lat,e.lng],{icon:l.divIcon({className:``,html:`<div style="background:${t.color};color:#fff;width:28px;height:28px;display:grid;place-items:center;border-radius:8px;border:2px solid #fff;box-shadow:0 2px 8px rgba(0,0,0,.25);font:800 10px/1 Inter,sans-serif;">${t.glyph}</div>`,iconSize:[28,28],iconAnchor:[14,14]})}).bindPopup(`<strong>${e.name}</strong><br/>${t.label}`).addTo(m)}),n.forEach(e=>{if(!e.lat||!e.lng)return;let t=i[e.urgency],n=e.urgency===`critique`?`#ef4444`:e.urgency===`eleve`?`#f97316`:`#10b981`,r=e.urgency===`critique`?10:e.urgency===`eleve`?8:6,a=`<div style="background:${n};color:#fff;width:${r*2}px;height:${r*2}px;display:grid;place-items:center;border-radius:50%;border:2px solid #fff;box-shadow:0 2px 8px rgba(0,0,0,.3);font:800 9px/1 Inter,sans-serif;">!</div>`;l.marker([e.lat,e.lng],{icon:l.divIcon({className:``,html:a,iconSize:[r*2,r*2],iconAnchor:[r,r]})}).bindPopup(`
          ...
          `).addTo(m)}),p.current=m,setTimeout(()=>m.invalidateSize(),120)})(),()=>{c=!0,p.current&&=(p.current.remove(),null)}},[t,n]),(0,u.jsx)(`div`,{ref:f,className:`${c} w-full overflow-hidden rounded-lg border bg-secondary`})}export{f as t};