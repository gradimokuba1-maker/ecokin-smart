...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-3qdcbccb.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CjoRgCie.mjs");
