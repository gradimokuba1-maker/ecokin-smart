...
import { K as detectCityCommune, R as Button, U as DEFAULT_CITY } from "./router-C5nfmudE.mjs";
import { a as pushLiveReport, n as SiteNav, s as useEcoUser } from "./site-nav-7GSWuwOx.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/signaler-DNQqtlY-.js
...
var SmartWasteCamera = (0, import_react.lazy)(() => import("./SmartWasteCamera-p3F36m9K.mjs").then((module) => ({ default: module.SmartWasteCamera })));
var CitizenGate = (0, import_react.lazy)(() => import("./citizen-gate-C_EW-EIt.mjs").then((module) => ({ default: module.CitizenGate })));
