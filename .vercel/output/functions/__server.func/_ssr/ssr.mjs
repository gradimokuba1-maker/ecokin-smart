import "../_runtime.mjs";
import { c as NodeResponse, l as FastURL, u as NullProtoObj } from "../_libs/h3+rou3+srvx.mjs";
...
import { a as defaultSerovalPlugins, c as makeSerovalPlugin, i as mergeHeaders, n as getNormalizedURL, o as createRawStreamRPCPlugin, r as getOrigin, s as createSerializationAdapter, t as attachRouterServerSsrUtils } from "../_libs/@tanstack/router-core+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BVNsprm2.mjs");
...
var manifest = {
	"4c2db2826bb73273e13ed421258788e28df030ab007357adaa5ed3497af7f168": {
		...
		importer: () => import("./waste-ai.functions-B1n_gTlH.mjs")
	},
...
var GLOBAL_STORAGE_KEY$1 = Symbol.for("tanstack-start:start-storage-context");
...
var getStartContextServerOnly = getStartContext$1;
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-C5nfmudE.mjs"),
		import("./start-DBFtVwls.mjs"),
