...
import { _ as KINSHASA_COMMUNES, h as DEFAULT_CITY, v as detectCityCommune } from "./ecokin-db-CVUKc8qE.mjs";
import { u as require_react } from "../_libs/@floating-ui/react-dom+[...].mjs";
import { i as pushLiveReport } from "./live-reports-CfR-HNOU.mjs";
import { i as formatNumber, n as useEcoUser, t as SiteNav } from "./site-nav-B-Or7zPf.mjs";
...
import { t as createSsrRpc } from "./createSsrRpc-BVca5LkM.mjs";
import { a as objectType, i as numberType, o as stringType, t as anyType } from "../_libs/zod.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/signaler-C97-F70T.js
...
var SUBMIT_TIMEOUT_MS = 12e3;
function withTimeout(promise, timeoutMs) {
	return Promise.race([promise, new Promise((_, reject) => {
		window.setTimeout(() => reject(/* @__PURE__ */ new Error("Delai de soumission depasse.")), timeoutMs);
	})]);
}
