...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-DqnPvYfW.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-YUeY4puj.mjs");
